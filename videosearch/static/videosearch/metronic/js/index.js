...
//            }
            ...
            function getRandomData() {
                //alert("Start generate data");
                var res = [];
                var tmp = 0;
                $.ajaxSettings.async = false;
                $.getJSON("/query/getCpuRatio", function (result_data, status) {
                    //alert("Data: " + result_data + "\nStatus: " + status);
                    //var cpuRatioInt = parseInt(result_data["cpuRatio"]);
                    //alert("cpuRatioInt is: " + cpuRatioInt);
                    //alert(typeof cpuRatioInt);
                    // = cpuRatioInt;

                    //alert(typeof result_data)
                    //alert(typeof result_data[1])

                    for (var i=0; i<result_data.length -1; i++){
                        res.push([i, result_data[i]]);
                    }


                    // zip the generated y values with the x values

                    //res.push([0, result_data]);
                    //var json_str = JSON.stringify(result_data)
                    //alert(typeof result_data);
                    //alert(typeof json_str);
                    //alert(json_str);

//                    res.push([0, cpuRatioInt]);
//                    res.push([1, 30]);
//                    res.push([2, 50]);
//                    res.push([3, 70]);
//                    res.push([4, 20]);
